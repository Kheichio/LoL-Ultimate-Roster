...
// Total players: 50
    ...
    { id: 11333, name: "Kerp",         role: "MID",   team: "MIL",  year: 2014, rating: 73, quality: "Silver",   region: "LEC", stats: { mec: 82, tmf: 74, frm: 71, cmp: 71, map: 73, ldr: 79 } },
    ...
    { id: 11345, name: "Unlimited",    role: "SUP",   team: "CW",   year: 2014, rating: 67, quality: "Silver",   region: "LEC", stats: { mec: 62, tmf: 76, frm: 65, cmp: 65, map: 75, ldr: 66 } },
    ...
    { id: 11391, name: "Huni",         role: "TOP",   team: "SKT",  year: 2017, rating: 78, quality: "Gold",     region: "LCK", stats: { mec: 87, tmf: 78, frm: 72, cmp: 72, map: 77, ldr: 82 } },
    ...
    { id: 11410, name: "Key",          role: "SUP",   team: "ROX",  year: 2017, rating: 71, quality: "Silver",   region: "LCK", stats: { mec: 66, tmf: 82, frm: 69, cmp: 70, map: 81, ldr: 69 } },
    ...
    { id: 11412, name: "Beyond",       role: "JNG",   team: "MVP",  year: 2017, rating: 71, quality: "Silver",   region: "LCK", stats: { mec: 73, tmf: 79, frm: 69, cmp: 69, map: 78, ldr: 73 } },
    ...
    { id: 11417, name: "Bless",        role: "JNG",   team: "BBQ",  year: 2017, rating: 66, quality: "Silver",   region: "LCK", stats: { mec: 68, tmf: 75, frm: 63, cmp: 63, map: 74, ldr: 68 } },
    ...
    { id: 11420, name: "Totoro",       role: "SUP",   team: "BBQ",  year: 2017, rating: 65, quality: "Silver",   region: "LCK", stats: { mec: 61, tmf: 74, frm: 63, cmp: 63, map: 73, ldr: 64 } },
    ...
    { id: 11425, name: "Ella",         role: "SUP",   team: "E8",   year: 2017, rating: 64, quality: "Silver",   region: "LCK", stats: { mec: 60, tmf: 73, frm: 62, cmp: 62, map: 72, ldr: 63 } },
    ...
    { id: 11457, name: "Pridestalker", role: "JNG",   team: "ROC",  year: 2017, rating: 68, quality: "Silver",   region: "LEC", stats: { mec: 70, tmf: 76, frm: 66, cmp: 66, map: 75, ldr: 71 } },
    ...
    { id: 11460, name: "Wadid",        role: "SUP",   team: "ROC",  year: 2017, rating: 68, quality: "Silver",   region: "LEC", stats: { mec: 63, tmf: 78, frm: 66, cmp: 66, map: 77, ldr: 67 } },
    ...
    { id: 11462, name: "Djoko",        role: "JNG",   team: "VIT",  year: 2017, rating: 69, quality: "Silver",   region: "LEC", stats: { mec: 71, tmf: 77, frm: 68, cmp: 68, map: 76, ldr: 72 } },
    ...
    { id: 11473, name: "xiaohu",       role: "MID",   team: "RNG",  year: 2017, rating: 82, quality: "Platinum", region: "LPL", stats: { mec: 89, tmf: 83, frm: 84, cmp: 83, map: 83, ldr: 86 } },
    ...
    { id: 11482, name: "Ning",         role: "JNG",   team: "IG",   year: 2017, rating: 75, quality: "Gold",     region: "LPL", stats: { mec: 77, tmf: 82, frm: 74, cmp: 74, map: 81, ldr: 77 } },
    ...
    { id: 11487, name: "World6",       role: "JNG",   team: "OMG",  year: 2017, rating: 65, quality: "Silver",   region: "LPL", stats: { mec: 67, tmf: 73, frm: 64, cmp: 64, map: 72, ldr: 68 } },
    { id: 11488, name: "icon",         role: "MID",   team: "OMG",  year: 2017, rating: 75, quality: "Gold",     region: "LPL", stats: { mec: 83, tmf: 76, frm: 76, cmp: 75, map: 76, ldr: 80 } },
    ...
    { id: 11492, name: "Swift",        role: "JNG",   team: "NB",   year: 2017, rating: 71, quality: "Silver",   region: "LPL", stats: { mec: 73, tmf: 78, frm: 70, cmp: 70, map: 77, ldr: 74 } },
    ...
    { id: 11495, name: "Crisp",        role: "SUP",   team: "NB",   year: 2017, rating: 73, quality: "Silver",   region: "LPL", stats: { mec: 67, tmf: 83, frm: 72, cmp: 72, map: 82, ldr: 71 } },
    ...
    { id: 11497, name: "Xinyi",        role: "JNG",   team: "JDG",  year: 2017, rating: 66, quality: "Silver",   region: "LPL", stats: { mec: 68, tmf: 75, frm: 64, cmp: 64, map: 74, ldr: 69 } },
    { id: 11498, name: "Doinb",        role: "MID",   team: "JDG",  year: 2017, rating: 73, quality: "Silver",   region: "LPL", stats: { mec: 80, tmf: 74, frm: 72, cmp: 72, map: 76, ldr: 79 } },
    ...
    { id: 11500, name: "LvMao",        role: "SUP",   team: "JDG",  year: 2017, rating: 70, quality: "Silver",   region: "LPL", stats: { mec: 65, tmf: 79, frm: 69, cmp: 69, map: 78, ldr: 68 } },
    ...
    { id: 11502, name: "SofM",         role: "JNG",   team: "SE",   year: 2017, rating: 72, quality: "Silver",   region: "LPL", stats: { mec: 74, tmf: 79, frm: 71, cmp: 71, map: 78, ldr: 74 } },
    { id: 11503, name: "Zz1tai",       role: "MID",   team: "SE",   year: 2017, rating: 73, quality: "Silver",   region: "LPL", stats: { mec: 81, tmf: 74, frm: 72, cmp: 72, map: 75, ldr: 79 } },
