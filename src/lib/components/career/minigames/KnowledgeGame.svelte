<script>
    ...
    const BANK = [
        ...
        { c: "TIMERS", t: 1, q: "During the laning phase, how often does a new minion wave spawn?",
          o: ["Every 30 seconds", "Every 20 seconds", "Every 25 seconds", "Every 45 seconds"],
          e: "A wave every thirty seconds is the metronome laning runs on - it speeds up later, but not while lanes still matter." },
        { c: "TIMERS", t: 2, q: "When does the first minion wave spawn from the Nexus?",
          o: ["0:30", "1:05", "0:55", "1:30"],
          e: "Waves start spawning at 0:30 and then every thirty seconds after it." },
        ...
        { c: "TIMERS", t: 2, q: "When does the Blue Sentinel first spawn?",
          o: ["0:55", "1:30", "1:05", "2:00"],
          e: "Buff camps are up at 0:55, which is why a jungler is already walking to their opener before the waves meet." },
        ...
        // =============================================================
        //  CURRENT-PATCH SET
        //  Every number below was checked against the League wiki rather
        //  than written from memory, because this is the half of the bank
        //  that rots: objectives, timers and the season's own systems get
        //  rebuilt most years, and a quiz that confidently teaches a value
        //  Riot changed two seasons ago is worse than a shorter quiz.
        //
        //  Checked against patch V26.17 (26 August 2026). Three questions
        //  in the set above were WRONG by then and were corrected in the
        //  same pass: the first wave spawns at 0:30 rather than 1:05, buff
        //  camps at 0:55 rather than 1:30, and "a wave every 30 seconds"
        //  now needs scoping to the laning phase.
        //
        //  If you revisit these, re-check them. Do not assume.
        // =============================================================

        // -- TIMERS ---------------------------------------------------
        { c: "TIMERS", t: 2, q: "When do the Voidgrubs spawn?",
          o: ["8:00", "5:00", "6:00", "10:00"],
          e: "Grubs are up at 8:00 and gone for good at 14:45, so the window to contest them is a single stretch of the early game." },
        { c: "TIMERS", t: 3, q: "How many times do the Voidgrubs spawn in a game?",
          o: ["Once, and they despawn permanently at 14:45", "Twice, at 6:00 and 12:00", "Three times, every four minutes", "Every six minutes until Baron"],
          e: "One spawn only. Miss the window and there is no second one - which is what makes the 8:00 timer worth setting up for." },
        { c: "TIMERS", t: 2, q: "When does the Rift Herald spawn?",
          o: ["15:00", "8:00", "10:00", "20:00"],
          e: "Herald arrives at 15:00 and leaves at 19:45, so it lives entirely in the gap between grubs and Baron." },
        { c: "TIMERS", t: 2, q: "When does Baron Nashor first spawn?",
          o: ["20:00", "15:00", "25:00", "18:00"],
          e: "Baron is up at 20:00, which is the same minute Atakhan arrives - the map has two competing calls at once." },
        { c: "TIMERS", t: 2, q: "When does Atakhan spawn?",
          o: ["20:00", "14:00", "25:00", "It spawns when a team takes their third drake"],
          e: "20:00, the same time as Baron. Deciding which of the two you are actually playing for is the whole point of it." },
        { c: "TIMERS", t: 3, q: "How long does the Crest of Insight (blue buff) last?",
          o: ["120 seconds", "90 seconds", "150 seconds", "180 seconds"],
          e: "Two minutes, and it resets to full for whoever kills the holder - so a stolen buff is a whole fresh one." },
        { c: "TIMERS", t: 2, q: "How long does the Elder Dragon buff last?",
          o: ["150 seconds", "180 seconds", "120 seconds", "90 seconds"],
          e: "Two and a half minutes of Aspect of the Dragon - shorter than Baron's three, and it is meant to end games rather than push lanes." },
        { c: "TIMERS", t: 2, q: "How long does an empowered (Homeguard) recall channel take?",
          o: ["4 seconds", "6 seconds", "2 seconds", "8 seconds, the same as a normal recall"],
          e: "Half a normal recall. Four seconds instead of eight is the difference between making the fight and watching it." },
        { c: "TIMERS", t: 3, q: "Once Elder Dragon has been taken, how long until the next one?",
          o: ["6 minutes", "5 minutes", "8 minutes", "It does not respawn"],
          e: "Six minutes, the same as Baron - so losing Elder without dying for it is not the end of the game." },
        { c: "TIMERS", t: 3, q: "After 30:00, how often does a minion wave spawn?",
          o: ["Every 20 seconds", "Every 30 seconds", "Every 25 seconds", "Every 15 seconds"],
          e: "Waves accelerate twice: 30 seconds early, 25 from 14:00, and 20 from 30:00. Late sieges are harder to hold for exactly this reason." },
        { c: "TIMERS", t: 3, q: "Within what window can a game be remade?",
          o: ["0:55 to 2:25", "1:30 to 3:00", "0:00 to 1:30", "3:00 to 5:00"],
          e: "0:55 to 2:25. The window is deliberately short - past it, a four-versus-five is a game you have to actually play." },

        // -- NUMBERS --------------------------------------------------
        { c: "NUMBERS", t: 1, q: "How many Voidgrubs spawn in the pit?",
          o: ["Three", "Two", "Four", "Six"],
          e: "Three, and taking all three is what unlocks the Voidmites that chew on turrets." },
        { c: "NUMBERS", t: 2, q: "How many plates does an outer turret have?",
          o: ["Five", "Three", "Six", "Four"],
          e: "Five plates. Taking the lot is 600 local gold before the turret itself has even fallen." },
        { c: "NUMBERS", t: 2, q: "How much local gold is a single turret plate worth?",
          o: ["120", "80", "150", "100"],
          e: "120 local gold each, split with nearby allies - which is why a jungler standing next to a plate is not just moral support." },
        { c: "NUMBERS", t: 2, q: "How many drakes does a team need to claim a Dragon Soul?",
          o: ["Four", "Three", "Five", "Two"],
          e: "Four. The fourth drake is the one worth dying for; the first three are worth positioning for." },
        { c: "NUMBERS", t: 3, q: "How many different drake types appear in any single game?",
          o: ["Three", "Six", "Four", "All of them"],
          e: "Six souls exist but only three drake types spawn per game, so the soul on offer is decided long before anybody can contest it." },
        { c: "NUMBERS", t: 3, q: "How many Faelights are on the map at the start of a game?",
          o: ["Twelve", "Eight", "Sixteen", "Four"],
          e: "Twelve at the start and sixteen once the Elemental Rift transforms - a warding map laid over the normal one." },
        { c: "NUMBERS", t: 3, q: "How much bonus sight radius does warding a Faelight grant?",
          o: ["25%", "10%", "50%", "15%"],
          e: "25% more radius plus vision of a bonus region for 45 seconds - the same ward, placed one step to the left, is worth noticeably more." },
        { c: "NUMBERS", t: 2, q: "How many points does the top lane Role Quest require?",
          o: ["1200", "800", "1350", "35"],
          e: "1200 for top, 1350 for mid and bot, 800 for support - and the jungle counts something else entirely." },
        { c: "NUMBERS", t: 3, q: "What does the support Role Quest reduce the cost of a Control Ward to?",
          o: ["40 gold", "50 gold", "30 gold", "75 gold"],
          e: "40 gold, which is the difference between warding properly and warding when you remember." },
        { c: "NUMBERS", t: 2, q: "How much do basic Boots cost?",
          o: ["300 gold", "350 gold", "250 gold", "400 gold"],
          e: "300 gold, and the first back is nearly always a question of whether you can afford them plus something else." },
        { c: "NUMBERS", t: 3, q: "If all three of a team's inhibitors are down, how many super minions spawn per lane per wave?",
          o: ["Two", "One", "Three", "One, but with double health"],
          e: "Two per lane per wave. That is usually the point at which defending stops being a plan." },

        // -- MECHANICS ------------------------------------------------
        { c: "MECHANICS", t: 2, q: "What does taking all three Voidgrubs give your team?",
          o: ["Voidmites that spawn to help attack enemy turrets", "Permanent bonus gold from minions", "A stacking damage buff against champions", "Vision of the enemy jungle"],
          e: "Three stacks unlocks Hunger of the Void, and the mites do the thing grubs are actually for: turrets." },
        { c: "MECHANICS", t: 2, q: "What happens when the Rift Herald is killed?",
          o: ["It drops the Eye of the Herald for 20 seconds, and whoever takes it can summon her", "It immediately charges the nearest lane", "It gives the whole team a permanent siege buff", "It grants vision of the enemy base"],
          e: "The Eye sits in the pit for twenty seconds. Killing Herald and then failing to pick her up is a real and very expensive mistake." },
        { c: "MECHANICS", t: 3, q: "What does slaying Thornbound Atakhan do?",
          o: ["Your team collects every Blood Rose on the map at once", "It permanently increases your team's turret damage", "It reveals the enemy team for 60 seconds", "It resets everyone's ultimate cooldowns"],
          e: "Every Blood Rose on the map, converted into Spirit Petals - which is why the fight for it is about the map, not the pit." },
        { c: "MECHANICS", t: 3, q: "What happens to the blue buff if the champion holding it is killed by an enemy champion?",
          o: ["It transfers to the killer with its timer reset to full", "It is destroyed", "It drops on the ground for anyone to pick up", "It returns to the jungle camp"],
          e: "It transfers AND resets, so killing a mid laner on blue is worth two more minutes than the timer suggested." },
        { c: "MECHANICS", t: 2, q: "What happens to a lane's minion wave once your inhibitor falls?",
          o: ["The enemy Nexus spawns a super minion in that lane, replacing the siege minion", "The lane stops spawning minions until it respawns", "Your minions gain bonus armour to compensate", "The lane's turrets gain a damage buff"],
          e: "A super minion in place of the cannon, every wave, for five minutes - it is a lane you now have to answer rather than ignore." },
        { c: "MECHANICS", t: 3, q: "How does the jungle Role Quest progress?",
          o: ["By feeding treats to your jungle pet", "By killing enemy champions in the jungle", "By taking every camp on your own half", "By placing wards in the river"],
          e: "35 points of treats, and completing it upgrades your Smite - the jungle quest is the only one not counted in the same currency as the lanes." },

        // -- ITEMS ----------------------------------------------------
        { c: "ITEMS", t: 2, q: "What does Runic Compass upgrade into once its quest is finished?",
          o: ["Bounty of Worlds", "World Atlas", "Celestial Opposition", "Zaz'Zak's Realmspike"],
          e: "800 gold of Shared Riches turns the Compass into Bounty of Worlds, and the ward stock goes from three charges to four." },
        { c: "ITEMS", t: 3, q: "How much gold must a support earn to complete the Runic Compass quest?",
          o: ["800", "500", "1000", "650"],
          e: "800 gold through Shared Riches and the item's own generation - it completes itself, but a support who never leaves lane completes it late." },
        { c: "ITEMS", t: 2, q: "How much does Runic Compass cost?",
          o: ["400 gold", "300 gold", "500 gold", "850 gold"],
          e: "400 gold for 100 health, regeneration and 5 gold every 10 seconds - a support's whole first back, and worth it." },
        { c: "ITEMS", t: 3, q: "How close must an allied champion be for Shared Riches to trigger?",
          o: ["1050 units", "600 units", "1500 units", "It works anywhere on the map"],
          e: "1050 units, which is roughly 'in the same lane as you' - the item is paying you to actually be next to your carry." },
        { c: "ITEMS", t: 2, q: "Which of these is a tier 2 boot?",
          o: ["Gluttonous Greaves", "Warden's Sabatons", "Sorcerer's Sandals", "Greaves of Alacrity"],
          e: "Gluttonous Greaves are the jungle pair. The other three do not exist." },
        { c: "ITEMS", t: 1, q: "Which boots give magic resistance and tenacity?",
          o: ["Mercury's Treads", "Plated Steelcaps", "Ionian Boots of Lucidity", "Boots of Swiftness"],
          e: "Mercury's Treads. Steelcaps are the armour pair, and buying the wrong one into a heavy comp is a real cost." },
        { c: "ITEMS", t: 1, q: "Which boots reduce ability and summoner spell cooldowns?",
          o: ["Ionian Boots of Lucidity", "Boots of Swiftness", "Berserker's Greaves", "Mercury's Treads"],
          e: "Ionian Boots. The summoner spell haste is the half people forget, and it is often the better half." },
        { c: "ITEMS", t: 2, q: "Which boots are the attack speed pair?",
          o: ["Berserker's Greaves", "Plated Steelcaps", "Boots of Swiftness", "Gluttonous Greaves"],
          e: "Berserker's Greaves - almost always the correct first completed item on a marksman." },
        { c: "ITEMS", t: 3, q: "How often does the Shared Riches passive generate a charge, and how many can be held?",
          o: ["One every 20 seconds, up to 3", "One every 30 seconds, up to 2", "One every 10 seconds, up to 5", "One per minion wave, up to 4"],
          e: "A charge every twenty seconds to a maximum of three, so a support who never spends them is throwing gold away slowly." },

        // -- META -----------------------------------------------------
        { c: "META", t: 2, q: "Which system replaced Feats of Strength?",
          o: ["Role Quests, with a different objective for each position", "A second Rift Herald", "Turret plating gold bounties", "A shared team levelling bar"],
          e: "Feats were removed and Role Quests took the slot - the reward is still an early power spike, but each role now earns its own." },
        { c: "META", t: 3, q: "What does completing the mid lane Role Quest give you?",
          o: ["Bonus AD and AP, plus a free boots upgrade", "300 gold immediately", "An upgraded Smite", "A second Teleport charge"],
          e: "8% AD and 8% AP with the boots upgrade thrown in, which is why a mid laner will farm a losing lane rather than roam off it." },
        { c: "META", t: 3, q: "What does completing the top lane Role Quest grant?",
          o: ["Unleashed Teleport and a raised level cap", "Bonus gold from every turret plate", "Permanent bonus armour", "A free Control Ward every recall"],
          e: "Teleport plus a level cap of 20 - the top lane quest is about getting to the rest of the map, and staying relevant once you do." },
        { c: "META", t: 2, q: "Why is the Voidgrub window worth planning for even if you do not want the objective?",
          o: ["It is the only time they ever spawn, so denying them is permanent", "They give the enemy team Baron buff", "They stop dragons from spawning", "They give permanent vision of your jungle"],
          e: "One spawn per game means every grub you deny is denied for the whole game, not until the next timer." },
        { c: "META", t: 3, q: "Baron and Atakhan both spawn at 20:00. What does that actually force?",
          o: ["A choice - you generally cannot set up for both at once", "Nothing, since one always spawns first", "Both teams must fight at Baron", "Atakhan always takes priority"],
          e: "Two objectives on one timer at opposite ends of the map is a macro decision disguised as an objective." },
        { c: "META", t: 2, q: "Why does warding a Faelight matter more than warding the bush beside it?",
          o: ["The ward gains bonus radius and reveals an extra region for 45 seconds", "The ward becomes invisible to the enemy", "The ward lasts twice as long", "It reveals the enemy jungler's position"],
          e: "Same ward, same cost, more map - which makes the good ward spots a thing you learn rather than a thing you guess." },
    ];
