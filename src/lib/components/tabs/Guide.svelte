<script>
    ...
    const sections = [
        ...
        { id: 'other', title: '🔧 Other Features', content: [
            ...
            { q: 'Updates & Guide', a: 'The Updates tab is a full, in-depth changelog of every patch, newest first. This Guide covers every game system. Both are reachable from the top navigation and from small islands on the Home page — the Home "Latest Updates" island shows a short preview and links into the full log.' },
