<script>
    ...
    const sections = [
        ...
        { id: 'rbc', title: '🧩 Roster Building Challenges (RBCs)', content: [
            { q: 'What are RBCs?', a: 'Roster Building Challenges live in the RBCs tab (between Academy and Season). Each is a daily puzzle: submit a themed set of 5 players from your Club and the cards are consumed in exchange for a free 5-card reward pack — no Blue Essence required.' },
            { q: 'How do rewards scale?', a: 'The more a challenge asks you to invest, the better the reward pack. Requirements and rewards climb together from an easy Premium pack all the way up to a full EWC pack.' },
        ...
        { id: 'other', title: '🔧 Other Features', content: [
            ...
            { q: 'Trade Market', a: 'Trade lower-tier cards for higher-tier players. 3 base offers (up to 5 with Trade Mastery skill). Offers rotate every 15 minutes. Pay 1,000 BE to refresh early (discounted by skill). Trades top out at Grandmaster — Challenger cards can\'t be traded for.' },
