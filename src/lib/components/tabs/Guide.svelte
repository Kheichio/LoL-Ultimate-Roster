<script>
    ...
    const sections = [
        ...
        { id: 'store', title: '📦 Store & Packs', content: [
            { q: 'Pack Types', a: 'Standard (100 BE) — up to Gold. Premium (600 BE) — up to Diamond. Elite (1,000 BE) — up to Master. First Stand (3,000 BE) — up to FirstStand. MSI (5,000 BE) — up to MSI. Champion (6,000 BE) — up to Champion. MVP (8,000 BE) — up to MVP.' },
        ...
        { id: 'changelog', title: '📋 Update Log', content: [
            { q: 'Beta 1.1.0 — Latest', a: '• DRAFT MODE — New gamemode! 15 random cards, 5 bans each side, build a squad, best of 5. Off-role flex penalty (-10 stats), legacy cards are wildcards\n• MSI 2026 LIMITED EVENT — 24hr global event with boosted MSI pack drop rates + guaranteed MSI card pity at 70 pulls\n• Wealth Management skill: +10% bonus BE from all rewards per level (max 5)\n• Conditioning skill now works: +1 total power per level across all modes\n• Dynamic milestones on Home: shows next uncompleted goals, auto-advances as you progress\n• Legacy & Award Cards collection tracker on Home page\n• Career stats expanded: all tournament wins (Cafe, Regional, First Stand, MSI, Worlds)\n• Coming Soon panel: Salary Cap Mode and Franchise Mode previews\n• Draft Mode and Salary Cap teasers in Play tab lobby\n• Card Showcase moved to Club with drag-and-drop reordering\n• Archive completion now uses full team size (search no longer tricks claim button)\n• Player ratings updated: ON (BLG) buffed to 97 — best support in the world' },
